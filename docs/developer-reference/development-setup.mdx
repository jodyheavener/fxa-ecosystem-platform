...
1. Once your services have all started up you should now be able to [visit FxA locally](http://localhost:3030). Next up you may want to [create an account](./local-accounts).
...
Check out the [PM2 docs](https://github.com/Unitech/PM2) for more commands. If you're using VS Code there is also a [handy extension](./vscode-development) for managing PM2 services.
...
:::tip
Looking for how to manage Yarn dependencies? [Click here](./yarn-dependencies) to learn more.
:::
...
- [Auth Server](#UPDATE-ME)
- [Payments Server](#UPDATE-ME)
